 ...
 * handles selections in a certain way.
 * 
...
public abstract class ADrawingState {
	 ...
	 *            NavigationHistory instance that shall be used.
	 */
	public ADrawingState(DrawingController drawingController, GLRadialHierarchy radialHierarchy,
	...
	/**
	 * Draws the radial hierarchy in a way specified by the concrete drawing state.
	 * 
	 * @param fXCenter
