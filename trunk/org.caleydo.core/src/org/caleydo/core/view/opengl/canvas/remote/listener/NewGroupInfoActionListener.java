...
public class NewGroupInfoActionListener
	extends AEventListener<INewGroupInfoHandler> {

	@Override
	public void handleEvent(AEvent event) {
		if (event instanceof NewGroupInfoEvent) {
			NewGroupInfoEvent newGroupInfoEvent = (NewGroupInfoEvent) event;
			handler.handleNewGroupInfo(newGroupInfoEvent.getVAType(), newGroupInfoEvent.getGroupList(),
				newGroupInfoEvent.isDeleteTree());
		}
	}
}
