...
public class DefaultTree extends AbstractTree {
	...
	// children.add(new DefaultTreeNode(tree, 1.0/12, Color.ORANGE, new
	// ArrayList<ATreeMapNode>(),"3.1"));
	// children.add(new DefaultTreeNode(tree, 1.0/12, Color.MAGENTA, new
	// ArrayList<ATreeMapNode>(),"3.2"));
	//
	// node=new DefaultTreeNode(tree, 1.0/6, null, children);
	// children = new ArrayList<ATreeMapNode>();
	// children.add(node);
	// children.add(new DefaultTreeNode(tree, 1.0/6, Color.GRAY, new
	// ArrayList<ATreeMapNode>(),"2.1"));
