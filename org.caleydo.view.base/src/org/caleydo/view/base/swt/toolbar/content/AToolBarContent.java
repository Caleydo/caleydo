...
/**
 * Abstract super class for toolbar content classes to provide lists of
 * toolbar-actions.
 * 
 * @author Werner Puff
 */
public abstract class AToolBarContent {
	...
	/**
	 * specifies that the toolbar should contain actions for standard rendering
	 * of the related view
	 */
	public static final int STANDARD_RENDERING = 1;

	/**
	 * specifies that the toolbar should contain actions for rendering
	 * contextual information only
	 */
	public static final int CONTEXT_ONLY_RENDERING = 2;

	/**
	 * FIXME view-id of the target view for the actions contained within this
	 * toolbar content
	 */
	protected ASerializedView targetViewData = null;

	/**
	 * specifies the type of content to render. sub classes may define their own
	 * content types
	 */
	protected int renderType = STANDARD_RENDERING;

	/**
	 * specifies the if the related view is attached or detached to caleydo's
	 * main window
	 */
	...
	/**
	 * Delivers the toolbar content. sub classes should return a list of
	 * toolbar-actions that are added to a toolbar.
	 * 
	...
	/**
	 * Delivers the content for the toolbar view for special behaviour sub
	...
	/**
	 * Delivers the content for the view-inline toolbar for special behaviour
	 ...
	 * might be obtained during initialization. Inherited objects should
