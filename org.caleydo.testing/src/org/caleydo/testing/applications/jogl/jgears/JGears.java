package org.caleydo.testing.applications.jogl.jgears;
...
import org.caleydo.testing.applications.jogl.gears.Gears;
	...
	extends GLJPanel
{
	...
	public JGears()
	{
		...
		// try {
		// InputStream in = JGears.class.getClassLoader().getResourceAsStream(
		// "demos/data/images/java_logo.png");
		// BufferedImage image = ImageIO.read(in);
		// javaImage = scaleImage(image, 0.25f, 0.25f);
		//
		// in = JGears.class.getClassLoader().getResourceAsStream(
		// "demos/data/images/opengl_logo.png");
	...
	public void paintComponent(Graphics g)
	{
		...
		if (javaImage != null)
		{
			...
			if (openglImage != null)
			{
				g.drawImage(openglImage, sp + javaImage.getWidth() + sp, getHeight()
						- openglImage.getHeight() - sp, null);
			}
		}
	}
	...
	// private BufferedImage scaleImage(BufferedImage img, float xScale, float
	// yScale) {
