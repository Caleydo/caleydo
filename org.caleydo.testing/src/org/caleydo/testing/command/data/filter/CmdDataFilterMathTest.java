...
public class CmdDataFilterMathTest extends TestCase {
	...
	{	
		CmdDataFilterMath createdCmd = (CmdDataFilterMath) myGeneralManager.getSingelton()
	...
	{	
		...
		IStorage myTargetStorage = myGeneralManager.getSingelton()
			.getStorageManager().createStorage(ManagerObjectType.STORAGE_FLAT);
		myGeneralManager.getSingelton().getStorageManager()
	...
	public void testLogToLinOverwriteFloat()
	{
		...
		IStorage myOriginalStorage = myGeneralManager.getSingelton()
		.getStorageManager().createStorage(ManagerObjectType.STORAGE_FLAT);

		myOriginalStorage.setArrayFloat(myGeneralManager.getSingelton().getStorageManager().getItemStorage(46301).getArrayFloat());
