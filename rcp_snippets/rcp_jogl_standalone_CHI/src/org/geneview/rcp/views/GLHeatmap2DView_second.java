...
public class GLHeatmap2DView_second extends ViewPart {

	public static final String ID = "org.geneview.rcp.views.GLHeatmap2DView_second";
	...
	public void createPartControl(Composite parent) {
		...
		JoglCanvasForwarder canvasForwarder = Application.refGeneralManager.getSingelton().getViewGLCanvasManager()
			.getGLCanvasDirector(28).getJoglCanvasForwarder();
