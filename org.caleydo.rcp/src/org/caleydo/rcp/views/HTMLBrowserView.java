	...
	extends ViewPart
{
	...
	public void createPartControl(Composite parent)
	{
		...
		CmdEventCreateMediator cmd = (CmdEventCreateMediator) Application.generalManager
		...
		CmdEventCreateMediator cmdReverse = (CmdEventCreateMediator) Application.generalManager
				.getCommandManager().createCommandByType(
						CommandQueueSaxType.CREATE_EVENT_MEDIATOR);
