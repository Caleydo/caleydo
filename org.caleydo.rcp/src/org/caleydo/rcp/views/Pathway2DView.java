	...
	extends ViewPart
{
	...
	public void createPartControl(Composite parent)
	{
		...
		// CmdEventCreateMediator cmd =
		// (CmdEventCreateMediator)Application.generalManager
		// .getSingelton().getCommandManager()
		// .createCommandByType(CommandQueueSaxType.CREATE_EVENT_MEDIATOR);
		// cmd.setAttributes(-1, iAlSender, iAlReceiver,
		// MediatorType.SELECTION_MEDIATOR);
		// cmd.doCommand();
		//
		// CmdEventCreateMediator cmdReverse =
		// (CmdEventCreateMediator)Application
		// .generalManager.getSingelton().getCommandManager()
		// .createCommandByType(CommandQueueSaxType.CREATE_EVENT_MEDIATOR);
		// cmdReverse.setAttributes(-1, iAlReceiver, iAlSender,
		// MediatorType.SELECTION_MEDIATOR);
