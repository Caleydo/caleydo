	...
	implements IPartListener2
{
	...
	public void partVisible(IWorkbenchPartReference partRef)
	{
		...
		final IToolBarManager toolBarManager = glView.getViewSite()
		...
		{			
			...
			((ToolBarView)PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().findView(
					ToolBarView.ID)).removeViewSpecificToolBar(glView.getGLEventListenerID());
		}
		else
		{
			((ToolBarView)PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().findView(
					ToolBarView.ID)).addViewSpecificToolBar(glView.getGLEventListenerID());
		}
	...
	public void partActivated(IWorkbenchPartReference partRef)
	{
		...
		((ToolBarView)PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().findView(
				ToolBarView.ID)).highlightViewSpecificToolBar(glView.getGLEventListenerID());
	}
