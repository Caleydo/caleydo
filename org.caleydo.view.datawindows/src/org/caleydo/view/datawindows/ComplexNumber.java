...
/**
 * ComplexNumber.java - 
 *   An object for representing and manipulating complex numbers.
 *
...
class ComplexNumber {
     ...
     *
     * @param realPart initial value for the real part of 
     ...
     * @param realPart initial value for the real part of 
     *                 the new ComplexNumber.
     * @param imagPart initial value for the imaginary part of 
     *                 the new ComplexNumber.
     */
    ...
    /**
     * Set the value of this ComplexNumber by specifying new
     * values for its real and imaginary parts.
     *
     * @param realPart new value for the real part of 
     *                 this ComplexNumber.
     * @param imagPart new value for the imaginary part of 
     *                 this ComplexNumber. 
     */
    ...
    /**
     * Set the value of this ComplexNumber to be the same as
     * the value of another ComplexNumber.
     *
     * @param theNum the ComplexNumber from which the real and 
     *               imaginary parts are to be copied into this
     *               ComplexNumber.
     */
    ...
    public ComplexNumber divide(ComplexNumber theNum){
    	return new ComplexNumber((realPart*theNum.realPart+imagPart*theNum.imagPart)/
    			(theNum.realPart*theNum.realPart+theNum.imagPart*theNum.imagPart),
    ...
    /**
     * Compute the square root of num and return a reference to 
     * a new ComplexNumber that contains the result.  Note that
     * num may be negative and thus a ComplexNumber may be necessary
     * to represent the square root.
     *
     * @param num the value of which the square root is to be found.
     * @return a reference to a new ComplexNumber equal to the 
     *         square root of num.
     */ 
