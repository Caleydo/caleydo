 ...
 *
 */
public class EntourageNonGeneticAdapterFactory implements ITourGuideAdapterFactory {
	public static final String SECONDARY_ID = "entourage.nongenetic";
	...
	public ITourGuideAdapter create() {
		return new EntourageNonGeneticAdapter();
	}
