...
public enum EGeneIDTypes {
	...
	DAVID(EDataType.INTEGER), GENE_SYMBOL(EDataType.STRING), GENE_NAME(
			EDataType.STRING), REFSEQ_MRNA(EDataType.STRING), ENSEMBL_GENE_ID(
			EDataType.STRING), ENTREZ_GENE_ID(EDataType.INTEGER),

	PATHWAY(EDataType.INTEGER), PATHWAY_VERTEX(EDataType.INTEGER), PATHWAY_VERTEX_REP(
			EDataType.INTEGER);
