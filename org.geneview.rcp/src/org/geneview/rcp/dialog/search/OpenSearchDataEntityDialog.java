package org.geneview.rcp.dialog.search;
...
extends Dialog 
{
	...
	protected void okPressed() {
		...
		boolean bFound = Application.geneview_core.getGeneralManager().getSingelton().getViewGLCanvasManager().getDataEntitySearcher()
