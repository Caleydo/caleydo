...
extends GeneralRenderStyle 
{
	...
	public static final float[] POLYLINE_SELECTED_COLOR = SELECTED_COLOR;//{1.0f, 0.0f, 0.0f, 1.0f};
	public static final float SELECTED_POLYLINE_LINE_WIDTH = 4.0f;
	
	public static final float[] POLYLINE_MOUSE_OVER_COLOR = MOUSE_OVER_COLOR;//{0.0f, 1.0f, 0.0f, 1.0f};
	...
	public static final float[] Y_AXIS_SELECTED_COLOR = SELECTED_COLOR;//{1.0f, 0.0f, 0.0f, 1.0f};
	public static final float Y_AXIS_SELECTED_LINE_WIDTH = 4.0f;
	public static final float[] Y_AXIS_MOUSE_OVER_COLOR = SELECTED_COLOR;//{0.0f, 1.0f, 0.0f, 1.0f};
