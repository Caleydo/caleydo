...
You will have to generate a new RSA key and save it to you ~/.ssh folder. This will result in a file ida_rsa and ida_rsa.pub turning up in your ssh folder.
