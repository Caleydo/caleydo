...
public interface IGraphItem extends IGraphDataHandler, IGraphItemHierarchy,
	 ...
	 * 
	 * @param prop
	 *            specify, which IGraphItem's should be returned; if prop ==
	 ...
	 *      EGraphItemProperty)
	 * @param item
	 *            new IGraphItem to be added and to be linked reverse to this
	 *            item;
	 * @param prop
	 *            property linked to the added item
	 * @throws GraphRuntimeException
	 ...
	 *            object to be tested
	 * @param prop
	 *            specify context; if prop == EGraphItemProperty.NONE or null
