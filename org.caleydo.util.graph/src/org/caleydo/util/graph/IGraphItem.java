	...
	extends IGraphDataHandler, IGraphItemHierarchy, IGraphComponent
{
	...
	/**
	 * Get a List of IGraphItem with respect to their EGraphItemProperty. Note,
	 * if prop == EGraphItemProperty.NONE or null all IGraphItem's are returned.
	 * 
	 * @param prop specify, which IGraphItem's should be returned; if prop ==
	...
	/**
	 * Adds a new IGraphItem with prop. Note, if prop == EGraphItemProperty.NONE
	 * or null a GraphRuntimeException is thrown
	 * 
	 * @see org.caleydo.util.graph.IGraphItem#addItemDoubleLinked(IGraphItem,
	 *      EGraphItemProperty)
	...
	/**
	 * Adds a new IGraphItem similar to addItem(IGraphItem, EGraphItemProperty)
	 * and also adds this item as reverse link to the new item. Revert entry is
	 * done for prop==(EGraphItemProperty.INCOMING, EGraphItemProperty.OUTGOING,
	 * EGraphItemProperty.ALIAS_PARENT,EGraphItemProperty.ALIAS_CHILD ) Note:
	 * EGraphItemProperty.NONE causes a GraphRuntimeException.
	 * 
	 * @see org.caleydo.util.graph.IGraphItem#addItem(IGraphItem,
	 *      EGraphItemProperty)
	 * @param item new IGraphItem to be added and to be linked reverse to this
	 *            item;
	 * @param prop property linked to the added item
	 * @throws GraphRuntimeException
	 */
	public void addItemDoubleLinked(IGraphItem item, EGraphItemProperty prop)
			throws GraphRuntimeException;

	/**
	 * Note, if prop == EGraphItemProperty.NONE or null IGraphItem is removed
	 * from any of the lists "INCOMING,OUTGOING" and "ALIAS"
	 * 
	 * @param item IGraphItem to be removed
	 * @param prop specify from which internal structure item should be removed
	 * @return TRUE if removal was successful, FLASE indicates that item was not
	 *         registered
	 */
	 ...
	 * @param prop specify context; if prop == EGraphItemProperty.NONE or null
