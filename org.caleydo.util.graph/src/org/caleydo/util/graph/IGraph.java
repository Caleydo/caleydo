...
public interface IGraph
	 ...
	 *          graph to be removed
	 * @param type
	 *          define type; only if type,graph matches the graph is removed and TRUE is returned; if type==null
	 *          or EGraphItemHierarchy.GRAPH_NONE graph is removed from any lists.
