	...
	extends IGraphComponent
{
	 ...
	 * Removes item
	 * 
	 * @param item IGraphItem to be removed * @return TURE if item was removed
	 ...
	 * 
	 * @param kind define which items, if prop==null all IGraphItem objects will
	 *            be returned.
	 ...
	 * @param type define EGraphItemHierarchy; EGraphItemHierarchy.GRAPH_NONE is
	 ...
	 * @param type define type; only if type,graph matches the graph is removed
