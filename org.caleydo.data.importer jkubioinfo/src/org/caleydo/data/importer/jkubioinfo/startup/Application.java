...
public class Application
	...
	public Object start(IApplicationContext context) throws Exception {
		...
		if (runConfigParameters == null || runConfigParameters.length != 2) {
			...
			inputDataTypeSetCollectionFile = System.getProperty("user.home")
					...
					+ "caleydo/data/JKU_BioInfo/mGlu2/export/caleydo_mGlu2.xml";

			outputCaleydoProjectFile = System.getProperty("user.home")
					+ System.getProperty("file.separator") + "caleydo/data/JKU_BioInfo/mGlu2/export/export_"
	...
	// ArrayList<RecordVirtualArray> vasToIntersect = new
	// ArrayList<RecordVirtualArray>(5);
	// // int loopCount = 0;
	...
	private void loadClusterInfo(String clusterFile) throws FileNotFoundException, IOException {
		...
		while (true) {
			...
			// TCGAIDStringConverter stringConverter = new
			// TCGAIDStringConverter();
			String originalID = columns[0];// stringConverter.convert(columns[0]);
	 ...
	 * @return
	 */
	private void runClusteringOnRows(boolean useKMeans, int numClusters) {
