...
public interface KEGGPortType extends Remote {
    ...
    public keggapi.LinkDBRelation[] get_linkdb_by_entry(String entry_id, String db, int start, int max_results) throws RemoteException;
    public keggapi.SSDBRelation[] get_best_neighbors_by_gene(String genes_id, int start, int max_results) throws RemoteException;
    public keggapi.SSDBRelation[] get_best_best_neighbors_by_gene(String genes_id, int start, int max_results) throws RemoteException;
    public keggapi.SSDBRelation[] get_reverse_best_neighbors_by_gene(String genes_id, int start, int max_results) throws RemoteException;
    public keggapi.SSDBRelation[] get_paralogs_by_gene(String genes_id, int start, int max_results) throws RemoteException;
    ...
    public keggapi.PathwayElement[] get_elements_by_pathway(String pathway_id) throws RemoteException;
    public keggapi.PathwayElementRelation[] get_element_relations_by_pathway(String pathway_id) throws RemoteException;
