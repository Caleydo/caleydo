...
import cerberus.parser.handler.importer.ascii.lookuptable.LookupTableHashMapLoader;
import cerberus.parser.handler.importer.ascii.lookuptable.LookupTableMultiMapIntLoader;
import cerberus.parser.handler.importer.ascii.lookuptable.LookupTableMultiMapStringLoader;

/**
 * @author Michael Kalkusch
 *
 * @see cerberus.parser.IParserObject
 */
...
//	}
	...
	/**
	 * Writes back Map to IGenomeIdManager by calling cerberus.parser.handler.importer.ascii.lookuptable.ILookupTableLoader#wirteBackMapToGenomeManager()
	 * 
	 * @see cerberus.parser.handler.importer.ascii.lookuptable.ILookupTableLoader#wirteBackMapToGenomeManager()
	 * @see cerberus.parser.handler.importer.ascii.AbstractLoader#copyDataToInternalDataStructures()
