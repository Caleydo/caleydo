...
implements IMementoXML, IParserObject {
	 ...
	 * 
	 * @see cerberus.parser.handler.importer.ascii.AbstractLoader#loadData_TestLinesToBeRead(BufferedReader)
	 * @see cerberus.parser.handler.importer.ascii.AbstractLoader#loadData_TestLinesToBeRead(String)
	 */
	 ...
	 * 
	 * @see cerberus.parser.handler.importer.ascii.AbstractLoader#progressBarSetStoreInitTitle(String, int, int)
	 * @see cerberus.parser.handler.importer.ascii.AbstractLoader#progressBarResetTitle()
	 * @see cerberus.parser.handler.importer.ascii.AbstractLoader#sLastProgressBarText
	 */
	 ...
	 * @see cerberus.parser.handler.importer.ascii.AbstractLoader#progressBarSetStoreInitTitle(String, int, int)
	 * @see cerberus.parser.handler.importer.ascii.AbstractLoader#progressBarResetTitle()
	 * @see cerberus.parser.handler.importer.ascii.AbstractLoader#iProgressBarLastPosition	 
	 */
	 ...
	 * 
	 * @see cerberus.parser.handler.importer.ascii.AbstractLoader#progressBarCurrentPosition()
	 */
	 ...
	 * 
	 * @see cerberus.parser.handler.importer.ascii.AbstractLoader#progressBarSetStoreInitTitle(String, int, int)
	 * @see cerberus.parser.handler.importer.ascii.AbstractLoader#progressBarStoredIncrement()
	 * @see cerberus.parser.handler.importer.ascii.AbstractLoader#fProgressBarInc
	 */
	 ...
	 * 
	 * @see cerberus.parser.handler.importer.ascii.AbstractLoader#progressBarStoredIncrement()
	 * @see cerberus.parser.handler.importer.ascii.AbstractLoader#fProgressBarIndex
	 */
	 ...
	 * 
	 * @see cerberus.parser.handler.importer.ascii.AbstractLoader#iLinesInFileToBeRead
	 * @see cerberus.parser.handler.importer.ascii.AbstractLoader#loadData_TestLinesToBeRead(BufferedReader)
	 * @see cerberus.parser.handler.importer.ascii.AbstractLoader#loadData_TestLinesToBeRead(String)
	 * 
	 ...
	 * 
	 * @see cerberus.parser.handler.importer.ascii.AbstractLoader#progressBarSetStoreInitTitle(String, int, int, int)
	 */
	protected final void progressBarSetStoreInitTitle(final String sText, 
			final int iCurrentProgressBarPosition,
			final int iStepsTill100_Percent ) {
