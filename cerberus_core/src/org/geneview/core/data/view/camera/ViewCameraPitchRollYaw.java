...
/**
 * Camera model using yaw, pitch and roll to manipulate the camera.
 * 
...
extends ViewCameraBase {
	...
	/**
	 * Updates quaternion from roll, pitch and yaw.
	 * If 
	 * prometheus.data.collection.view.camera.ViewCameraPitchRollYaw#bEnableImmediateCameraUpdate
	 * is TRUE the ViewMatrix is updated by calling 
	 ...
	 * @see prometheus.data.collection.view.camera.ViewCameraBase#getCameraMatrix()
	 * 
	 * @param bImmediateUpdate TRUE force an immediate update once a setter is called, which recalulates the ViewMatrix
	 */
	...
	public String toString() {
		return  "[" + super.toString() +
			" (" + Float.toString( fYawX ) +
			"|" + Float.toString( fPitchY ) +
