...
/**
 * PDDrawingStrategyFixedColor uses a definable color for drawing the partial disc. The color is not affected by any of
 * the partial disc's properties.
 * 
...
public class PDDrawingStrategyFixedColor extends APDDrawingStrategyChildIndicator {
	 ...
	 */
	public PDDrawingStrategyFixedColor(SpacePickingManager pickingManager) {
