package org.caleydo.view.differenceplot.toolbar;
...
public class DataSelectionBarGUI extends ControlContribution
{
	...
	private GLDifferenceplot parentView;

	public GLDifferenceplot getParentView() {
		return parentView;
	}

	public void setParentView(GLDifferenceplot parentView) {
		this.parentView = parentView;
	}

	public DataSelectionBarGUI(GLDifferenceplot parentView) {
...
//		});
	...
	private void setDataColumnCombos()
	{
		...
		if(visDomainCombo.getSelectionIndex() == -1 )
		{
			return;
		}
	...
	public void HandleDataSelectionFinishedSignal()
	{
		...
		// always derived in difference view
		...
		.get()
		.getEventPublisher()
		.triggerEvent(new DifferenceplotDataSelectionEvent(dataSelectionConf, parentView.getID()));
	}
