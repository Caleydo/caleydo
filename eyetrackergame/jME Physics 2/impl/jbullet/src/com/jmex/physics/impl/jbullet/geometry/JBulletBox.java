...
import com.jmex.physics.impl.jbullet.geometry.proxies.BoxProxy;
import com.jmex.physics.material.Material;

public class JBulletBox extends PhysicsBox implements JBulletGeometry {
    ...
    public JBulletBox( PhysicsNode node ) {
        super( node );
        shape = new BoxProxy( new Vector3f( 0.5f, 0.5f, 0.5f ) , this);
    }
