...
public class BipartiteEdgeBandRenderer extends AEdgeBandRenderer {
	...
	protected void determineNodeConnectors(
		...
		ANodeConnector connector1 = new TopSideConnector(bottomNode,
				pixelGLConverter, connectionBandRenderer, viewFrustum, topNode);
		ANodeConnector connector2 = new BottomSideConnector(topNode,
				pixelGLConverter, connectionBandRenderer, viewFrustum,
				bottomNode);
