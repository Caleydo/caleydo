...
/**
 * Helper class converts enzyme codes that are given space separated. EXAMPLE: Input 2;1.2.3 2.4.5 Output:
 * 2;1.2.3 2;2.4.5
 * 
 * @author Marc Streit
 */
public class EnzymeCodeConverter {
	...
	protected void convertData() throws IOException {
		...
		BufferedReader in =
			new BufferedReader(new FileReader("data/MicroarrayData/mapping/gene_id_2_enzyme_code_ORIG.map"));
		...
		while ((sInputLine = in.readLine()) != null) {
			...
			StringTokenizer strTokenText = new StringTokenizer(sConvertedInputLine, sEnzymeSeparator);
