...
public class JoglSwingFrameFactory {
	...
	public static void main(String[] args) {
		...
		new JoglSwingFrameFactory().run(args);
	}

	protected JoglSwingFrameFactory() {
		initDatastructures();		
	}
	...
	protected synchronized void registerJInternalFrame( final JInternalFrame refJInternalFrame,
	...
	protected synchronized void unregisterJInternalFrame( final JInternalFrame refJInternalFrame ) {
		vec_JInternalFrame.removeElement( refJInternalFrame );
	}
	
	protected synchronized void registerJFrame( final JFrame refJFrame,
			final String sFrameTitle ) {
		//private void registerInternalFrame( final JInternalFrame refJInternalFrame ) {
	...
	protected synchronized void unregisterJFrame( final JFrame refJFrame ) {
