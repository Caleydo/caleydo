...
public class CollectionBrowser  {
  ...
  public static void main(String[] args) {
    ...
    CollectionBrowser demo = new CollectionBrowser( baseFrame );
  ...
  public CollectionBrowser(JFrame setRefParentExternalFrame) {
  ...
  public CollectionBrowser(JInternalFrame setRefParentInternalFrame) {
