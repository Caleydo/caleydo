...
public class JoglHistogram_StaticArray extends Demo {
	
  public static void main(String[] args) {
    GLCanvas canvas = new GLCanvas();
    final Animator animator = new Animator(canvas);
    
    JoglHistogram_StaticArray demo = new JoglHistogram_StaticArray(canvas,animator);
...
//  private int[] iHistogramIntervalls = null;
  ...
  public JoglHistogram_StaticArray( GLCanvas canvas, final Animator animator ) {
  ...
  public JoglHistogram_StaticArray( ) {
  ...
  public void createHistogram(final int iHistogramLevels) {
	  ...
	  histogramCreator.addData( refSet );
	  
	  histogramCreator.addDataValues( i_dataValues );	  
	  histogramCreator.setIntervalEqualSpacedInt( iHistogramLevels ,
			  enumCurrentHistogramMode,
			  true, 0 , 0 );
	
	  HistogramData refResultBuffer = histogramCreator.getUpdatedHistogramData();
