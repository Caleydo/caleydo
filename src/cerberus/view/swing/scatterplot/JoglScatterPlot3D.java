...
public class JoglScatterPlot3D extends Demo {
	
  public static void main(String[] args) {
    GLCanvas canvas = new GLCanvas();
    final Animator animator = new Animator(canvas);
    
    JoglScatterPlot3D demo = new JoglScatterPlot3D(canvas,animator);
...
//  private int[] iHistogramIntervalls = null;
  ...
  public JoglScatterPlot3D( GLCanvas canvas, final Animator animator ) {
	  
	  doMinMaxData = new MinMaxDataInteger(3);  
...
//				  Integer.toString(iSetLegth) + ") exceeded range [3..10000]");
  ...
  public void displayScatterplot(GLAutoDrawable drawable) {
		if (!initComplete) {
			return;
		}
		...
		if (this.refSet != null) {
			...
			if (refSet.getReadToken()) {
				...
				if (refSet.getDimensions() < 3) {
					System.out
							.println("JoglScatterPlot3D.displayHistogram() Can not use a ISet with only one dimension!");
				}

				IStorage refStorageX = this.refSet.getStorageByDimAndIndex(0, 0);
				IStorage refStorageY = this.refSet.getStorageByDimAndIndex(1, 0);
				IStorage refStorageZ = this.refSet.getStorageByDimAndIndex(2, 0);

				int[] i_dataValuesX = refStorageX.getArrayInt();
				int[] i_dataValuesY = refStorageY.getArrayInt();
				int[] i_dataValuesZ = refStorageY.getArrayInt();
				...
				if (( i_dataValuesX != null ) && 
					...
					float fIncZ = (fMaxZ - fMinZ) 
							/ (float) (doMinMaxData.getMax(2) - doMinMaxData.getMin(2));
					...
					while ((iterX.hasNext()) && (iterY.hasNext())) {
						...
						float z = (float) i_dataValuesZ[iterZ.next()] * fIncZ + fMinZ;
...
//					};
					...
					ByteBuffer bufferByte = ByteBuffer.allocateDirect(8*4); 
					
					bufferByte.putFloat(0,fMinX);
					bufferByte.putFloat(1,fMinY);
					bufferByte.putFloat(2,fMinZ);
					
					bufferByte.putFloat(3,fMaxX);
					bufferByte.putFloat(4,fMinY);
					bufferByte.putFloat(5,fMinZ);
					
					bufferByte.putFloat(6,fMaxX);
					bufferByte.putFloat(7,fMaxY);
					bufferByte.putFloat(8,fMinZ);
					
					bufferByte.putFloat(9,fMinX);
					bufferByte.putFloat(10,fMaxY);
					bufferByte.putFloat(11,fMinZ);
					
	
					bufferByte.putFloat(12,fMinX);
					bufferByte.putFloat(13,fMinY);
					bufferByte.putFloat(14,fMaxZ);
					
					bufferByte.putFloat(15,fMaxX);
					bufferByte.putFloat(16,fMinY);
					bufferByte.putFloat(17,fMaxZ);
					
					bufferByte.putFloat(18,fMaxX);
					bufferByte.putFloat(19,fMaxY);
					bufferByte.putFloat(20,fMaxZ);
					
					bufferByte.putFloat(21,fMinX);
					bufferByte.putFloat(22,fMaxY);
					bufferByte.putFloat(23,fMaxZ);
...
//					gl.glArrayElement(7);
					...
					gl.glBegin(GL.GL_LINE_LOOP);
					gl.glVertex3f(fMinX, fMinY, fMinZ);
					gl.glVertex3f(fMaxX, fMinY, fMinZ);
					gl.glVertex3f(fMaxX, fMaxY, fMinZ);
					gl.glVertex3f(fMinX, fMaxY, fMinZ);
					gl.glEnd();
					
					gl.glBegin(GL.GL_LINE_LOOP);
					gl.glVertex3f(fMinX, fMinY, fMaxZ);
					gl.glVertex3f(fMaxX, fMinY, fMaxZ);
					gl.glVertex3f(fMaxX, fMaxY, fMaxZ);
					gl.glVertex3f(fMinX, fMaxY, fMaxZ);
					gl.glEnd();
