...
implements IMementoXML, IParserObject {
	 ...
	 * 
	 * @see cerberus.xml.parser.handler.importer.ascii.AbstractLoader#loadData_TestLinesToBeRead(BufferedReader)
	 * @see cerberus.xml.parser.handler.importer.ascii.AbstractLoader#loadData_TestLinesToBeRead(String)
	 */
	 ...
	 * @see cerberus.xml.parser.handler.importer.ascii.AbstractLoader#sLastProgressBarText
	 */
	 ...
	 * @see cerberus.xml.parser.handler.importer.ascii.AbstractLoader#progressBarSetStoreInitTitle(String, int, int)
	 * @see cerberus.xml.parser.handler.importer.ascii.AbstractLoader#progressBarResetTitle()
	 * @see cerberus.xml.parser.handler.importer.ascii.AbstractLoader#iProgressBarLastPosition	 
	 */
	 ...
	 * 
	 * @see cerberus.xml.parser.handler.importer.ascii.AbstractLoader#progressBarCurrentPosition()
	 */
	 ...
	 * @see cerberus.xml.parser.handler.importer.ascii.AbstractLoader#fProgressBarInc
	 */
	 ...
	 * 
	 * @see cerberus.xml.parser.handler.importer.ascii.AbstractLoader#progressBarStoredIncrement()
	 * @see cerberus.xml.parser.handler.importer.ascii.AbstractLoader#fProgressBarIndex
	 */
	 ...
	 * 
	 * @see cerberus.xml.parser.handler.importer.ascii.AbstractLoader#iLinesInFileToBeRead
	 * @see cerberus.xml.parser.handler.importer.ascii.AbstractLoader#loadData_TestLinesToBeRead(BufferedReader)
	 * @see cerberus.xml.parser.handler.importer.ascii.AbstractLoader#loadData_TestLinesToBeRead(String)
	 * 
	 ...
	 * 
	 * @see cerberus.xml.parser.handler.importer.ascii.AbstractLoader#progressBarSetStoreInitTitle(String, int, int, int)
	 */
	protected final void progressBarSetStoreInitTitle(final String sText, 
			final int iCurrentProgressBarPosition,
			final int iStepsTill100_Percent ) {
