...
public class Header extends MessageBorders {
	...
	public Header( Header cloneHeader ) {			
		...
		assert cloneHeader != null : "Can not handel null-pointer";
	 ...
	 * 
	 * @see org.studierstube.net.protocol.muddleware.Message#parseHeaderOnly(byte[])
	 * @see org.studierstube.net.protocol.muddleware.Message#parseByteArray(byte[])
	 * @see org.studierstube.net.protocol.muddleware.Message#parseByteArrayFromInStream(InputStream, ErrorMessageHandler)
	 * 
