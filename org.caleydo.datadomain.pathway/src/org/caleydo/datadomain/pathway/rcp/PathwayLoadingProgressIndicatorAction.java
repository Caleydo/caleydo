...
//						createPathwayDataDomain(EPathwayDatabaseType.KEGG);
...
//						createPathwayDataDomain(EPathwayDatabaseType.BIOCARTA);
						// monitor.worked(50);
					}
	...
	private void createPathwayDataDomain(EPathwayDatabaseType pathwayDatabaseType) {
		PathwayDataDomain dataDomain = new PathwayDataDomain();
		dataDomain.init();
		Thread thread = new Thread(dataDomain, dataDomain.getDataDomainType());
		thread.start();
		dataDomain.setPathwayDatabaseType(pathwayDatabaseType);
