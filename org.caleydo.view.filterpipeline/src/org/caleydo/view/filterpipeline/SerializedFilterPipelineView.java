...
@XmlRootElement
@XmlType
public class SerializedFilterPipelineView extends ASerializedSingleDataContainerBasedView {
	...
	public SerializedFilterPipelineView(ISingleDataContainerBasedView view) {
		super(view);
	}
