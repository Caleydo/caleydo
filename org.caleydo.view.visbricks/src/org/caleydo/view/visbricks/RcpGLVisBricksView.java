...
public class RcpGLVisBricksView extends ARcpGLViewPart {
	...
	public void createPartControl(Composite parent) {
		...
		createGLCanvas();
		GLVisBricks glVisBricks = new GLVisBricks(glCanvas, parentComposite,
		...
		if (view instanceof IDataDomainBasedView<?>) {
			...
			SerializedVisBricksView serializedVisBricksView = (SerializedVisBricksView) serializedView;
