...
public class CategoricalDataConfigurer implements IBrickConfigurer {
	...
	public void configure(CentralBrickLayoutTemplate layoutTemplate) {
		...
		validViewTypes.add(EContainedViewType.CATEGORY);
		...
		// BrickViewSwitchingButton tagCloudButton = new
		// BrickViewSwitchingButton(
		// EPickingType.BRICK_TOOLBAR_VIEW_SWITCHING_BUTTONS,
		...
		// HashSet<EContainedViewType> validViewTypes = new
		// HashSet<EContainedViewType>();
	...
	public void setBrickViews(GLBrick brick, GL2 gl, GLMouseListener glMouseListener,
		...
		// glMouseListener);
		// AContainedViewRenderer tagCloudLayoutRenderer = new
