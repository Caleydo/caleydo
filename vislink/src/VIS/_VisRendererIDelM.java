...
public final class _VisRendererIDelM extends Ice._ObjectDelM implements _VisRendererIDel
{
    public void
    clearAll(java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("clearAll", Ice.OperationMode.Normal, __ctx);
        try
        {
    ...
    clearSelections(java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("clearSelections", Ice.OperationMode.Normal, __ctx);
        try
        {
            boolean __ok = __og.invoke();
            if(!__og.is().isEmpty())
    ...
    getAccessInformation(int sourceApplicationId, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("getAccessInformation", Ice.OperationMode.Normal, __ctx);
        try
        {
            try
            {
                IceInternal.BasicStream __os = __og.os();
                __os.writeInt(sourceApplicationId);
            }
            catch(Ice.LocalException __ex)
            {
                __og.abort(__ex);
            ...
            try
            {
                ...
                AccessInformation __ret;
                __ret = new AccessInformation();
                __ret.__read(__is);
                __is.endReadEncaps();
                return __ret;
            }
    ...
    registerSelectionContainer(SelectionContainer container, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("registerSelectionContainer", Ice.OperationMode.Normal, __ctx);
        try
        {
            try
            {
    ...
    renderLinks(SelectionGroup selections, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("renderLinks", Ice.OperationMode.Normal, __ctx);
        try
        {
            try
            {
    ...
    unregisterSelectionContainer(int id, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("unregisterSelectionContainer", Ice.OperationMode.Normal, __ctx);
        try
        {
            try
            {
    ...
    updateSelectionContainer(SelectionContainer container, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("updateSelectionContainer", Ice.OperationMode.Normal, __ctx);
        try
        {
            try
            {
