...
public class ListBoxAndWhiskersElement extends ABoxAndWhiskersElement {
	...
	public ListBoxAndWhiskersElement(IDoubleList data, EDetailLevel detailLevel, EDimension direction,
		...
		this(data, detailLevel, direction, showOutlier, showMinMax, label, color, Float.NaN, Float.NaN);
	}

	public ListBoxAndWhiskersElement(IDoubleList data, EDetailLevel detailLevel, EDimension direction,
			boolean showOutlier, boolean showMinMax, String label, Color color, Float min, Float max) {
