 ...
 *******************************************************************************/
package org.caleydo.view.tourguide.toolbar;
...
public class TourGuideToolBarContent extends AToolBarContent {

	public static final String IMAGE_PATH = "resources/icons/icon.png";

	public static final String VIEW_TITLE = "Tour Guide";
	...
	protected List<ToolBarContainer> getToolBarContent() {
		...
		List<ToolBarContainer> list = new ArrayList<ToolBarContainer>();
		list.add(container);
