...
public class PathwayListGenerator {
	...
	public final static String INPUT_FOLDER_PATH_BIOCARTA = "data/html/";
	public final static String INPUT_IMAGE_PATH_BIOCARTA = "data/images/";
	public final static String OUTPUT_FILE_NAME_BIOCARTA_HOMO_SAPIENS = "data/pathway_list_BIOCARTA_homo_sapiens.txt";
	public final static String OUTPUT_FILE_NAME_BIOCARTA_MUS_MUSCULUS = "data/pathway_list_BIOCARTA_mus_musculus.txt";
