 ...
 * 
 */
public class KeggPathwayImageCacherFTP
	extends Thread
{
	 ...
	 * Constructor.
	 */
	public KeggPathwayImageCacherFTP(final Display display, final ProgressBar progressBar,
	...
	public void run()
	{
		...
		Logger log = Logger.getLogger(KeggPathwayImageCacherFTP.class);
