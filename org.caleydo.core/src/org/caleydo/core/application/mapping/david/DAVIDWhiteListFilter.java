...
//	private static final String FILE_NAME = "DAVID2REFSEQ_MRNA.txt";
	...
	throws IOException {
	    ...
	    BufferedReader in = new BufferedReader(
	      new FileReader("data/genome/mapping/david/" + FILE_NAME));
	    
	    String sInputLine = "";
	    String sFilter = "";
	    
	    BufferedReader whitelist = new BufferedReader(
		  	      new FileReader("data/genome/mapping/david/DAVID_HOMO_SAPIENS.txt"));
	    ...
	    while ((sInputLine = in.readLine()) != null)
	    {
    		...
    		if (alFilter.contains(StringConversionTool.convertStringToInt(tokenizer.nextToken(), -1))
    ...
    public static void main(String[] args) {
    	...
    	try {	
    		DAVIDWhiteListFilter whitelistFilter = 
        		new DAVIDWhiteListFilter();
