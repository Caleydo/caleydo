...
public class MultipleAccessionCodeExtractor
{
	...
	protected void convertData() throws IOException
	{
		...
		{
			sAccessionCodes = sInputLine.substring(0, sInputLine
					.indexOf(cAccessionToExpressionStorageIndexDelimiter));
			...
			{
				sMicroarrayExpressionStorageIndex = sInputLine.substring(sInputLine
						.indexOf(cAccessionToExpressionStorageIndexDelimiter) + 1, sInputLine
						.length());
