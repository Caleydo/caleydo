 ...
 * {@link CreateGUIViewEvent}s are only handled if they do not have a target application name specified
 * or the specified target application name is equals to this network name the 
 * executing caleydo application.
 *  
 * @author Werner Puff
 */
public class CreateGUIViewListener
	...
	public void handleEvent(AEvent event) {
		if (event instanceof CreateGUIViewEvent) {
			...
			String target = createSWTViewEvent.getTargetApplicationName();
