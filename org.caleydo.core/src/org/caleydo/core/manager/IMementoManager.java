...
extends IGeneralManager
{
	...
	/**
	 * Add a new IMemento to the IMementoManager and register a unique MementoName.
	 * 
	 * @param addMemento
	 * @param sMementoId
	 * @return unique mementoId
	 ...
	 * The iMementoId is created by the IMementoManager @see setMemento()
	 * 
	 ...
	 * The sMementoId is added to the IMementoManager @see setMemento()
	 * 
	 * @param iMementoId
