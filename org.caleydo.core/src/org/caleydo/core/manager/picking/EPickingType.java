...
public enum EPickingType
{
	...
	BUCKET_REMOVE_ICON_SELECTION(EManagedObjectType.GL_REMOTE_RENDERING),
	BUCKET_DRAG_ICON_SELECTION(EManagedObjectType.GL_REMOTE_RENDERING),
	// BUCKET_SEARCH_PATHWAY,
	VIEW_SELECTION(EManagedObjectType.GL_REMOTE_RENDERING),
	REMOTE_LEVEL_ELEMENT(EManagedObjectType.GL_REMOTE_RENDERING),
	MEMO_PAD_SELECTION(EManagedObjectType.GL_REMOTE_RENDERING),

	// selection panel
	SELECTION_PANEL_ITEM(EManagedObjectType.GL_SELECTION_PANEL),
	...
	HIER_HEAT_MAP_CURSOR(EManagedObjectType.GL_HIER_HEAT_MAP),
	HIER_HEAT_MAP_VIEW_SELECTION(EManagedObjectType.GL_HIER_HEAT_MAP),
	HIER_HEAT_MAP_TEXTURE_CURSOR(EManagedObjectType.GL_HIER_HEAT_MAP),
