...
public interface IGroupwareManager
	...
	/**
	 * Uses this caleydo application as caleydo server application.
	 * Needed paramters are implementation specific and have to be provided before
	 * calling this method.  
	 */
	public void startServer();
	
	/**
	 * Starts this caledyo application as a client. 
	 * Needed paramters are implementation specific and have to be provided before
	 * calling this method.  
	 */
	...
	/**
	 * Retrieves the caleydo network name of the caleydo application that
	 * initiated the recent event.
	 * This method is only useful in multi user environments like deskotheque. 
	 * @return private caleydo application network name
	 */
	public String getHomeGroupwareClient();
	
	/**
	 * Retrieves the caleydo network name of a public caleydo application.
	 * The determination of the application is group ware specific.
	...
	/**
	 * Stops all groupware related operations like network communication 
	 * and frees needed resources.
	 */
	public void stop();
	...
	/**
	 * On clients it returns the {@link ApplicationInitData} as retrieved from the server
	 * to startup a client in the same manner as the server.
	...
	/**
	 * <code>true</code> if the used groupware system is able to draw display comprehensive
	 * connection lines, <code>false</code> otherwise.
	 * @return
	 */
