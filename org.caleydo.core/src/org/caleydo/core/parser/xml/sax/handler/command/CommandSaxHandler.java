	...
	extends AXmlParserHandler
{
	...
	// * @param bIsExternalFrame
	// */
	// protected void readCommandQueueData(final Attributes attrs, boolean
	// bIsExternalFrame)
	// {
	//
	// ICommand lastCommand = null;
	...
	// ECommandType.COMMAND_QUEUE_RUN
	// .toString());
	//
	...
	// {
	// assert false :
	// "COMMAND_QUEUE_OPEN: already one queue is beeing processed!";
	// }
	//
