...
public interface ILookupTableLoader
{
	...
	/**
	 * Write data back to IGenomeIdManager. This mehtode is called by
	 * LookupTableLoaderProxy#copyDataToInternalDataStructures(), which is
	 * derived from AbstractLoader#copyDataToInternalDataStructures().
	 * 
