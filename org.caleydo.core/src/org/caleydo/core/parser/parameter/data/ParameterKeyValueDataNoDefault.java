...
/**
 * Stores key-value pair and default-key,default-value in same place. Attention: Default values mut be set
 * before key-value pair are set, because otherwise they would be overwritten!
 * 
...
public final class ParameterKeyValueDataNoDefault<T>
	 ...
	 * @see org.caleydo.core.parser.parameter.IParameterKeyValuePair# setValueAndDefaultValue(Stringt, null,
	 *      null)
	 */
