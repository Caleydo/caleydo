	...
	implements Serializable, RevisionHandler
{
	...
	protected void addInstance(Instance newInstance) throws Exception
	{
		...
		{
			/*
			 * we are a leaf, so make our existing instance(s) into a child and
			 * then add the new instance as a child
			 */
	 ...
	 * @param delete
	 *            true if the values of the supplied instance are to be removed
	 *            from the statistics
	 */
