...
public class ClusterConfiguration {
	...
	public ClusterConfiguration(EClustererAlgo algo, ClustererType type,
			EDistanceMeasure dist) {
	...
	/**
	 * @return the kMeansNumberOfClustersForRecords, see
	 *         {@link #kMeansNumberOfClustersForRecords}
	 */
	 ...
	 */
	public void setkMeansNumberOfClustersForDimensions(
			int kMeansNumberOfClustersForDimensions) {
		this.kMeansNumberOfClustersForDimensions = kMeansNumberOfClustersForDimensions;
	}

	/**
	 * @return the kMeansNumberOfClustersForDimensions, see
	 *         {@link #kMeansNumberOfClustersForDimensions}
	 */
	...
	public void setAffinityPropClusterFactorExperiments(
			float fAffinityPropClusterFactorExperiments) {
	...
	public String toString() {
		return "Algorithm: " + clustererAlgo;
	}
