...
import static org.caleydo.core.startup.internal.LoadProjectStartupAddon.PREFERENCE_LOAD_CALEYDO_PROJECT;
...
public class OpenProjectCommand extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (fileName != null) {
			...
			// store for the restart
			store.setValue(PREFERENCE_LOAD_CALEYDO_PROJECT, fileName);
