...
public class InteractiveSplashHandler extends AbstractSplashHandler {
	...
	private void createUI() {
		...
		// brandingLabelTUGCaption.setFont(new Font(splash.getDisplay(),
		// "Arial", 8, SWT.BOLD));
		...
		// brandingLabelTUGTeamCaption.setFont(new Font(splash.getDisplay(),
		// "Arial", 8,
		// SWT.NORMAL));
		...
		// brandingLabelJKUCaption.setFont(new Font(splash.getDisplay(),
		// "Arial", 8, SWT.BOLD));
		...
		// brandingLabelJKUTeamCaption.setFont(new Font(splash.getDisplay(),
		// "Arial", 8,
		// SWT.NORMAL));
		...
		// brandingLabelHarvardTeamCaption.setFont(new Font(splash.getDisplay(),
		// "Arial", 8,
		// SWT.NORMAL));
		...
		// copyrightLabel.setFont(new Font(splash.getDisplay(), "Arial", 8,
		// SWT.BOLD));
