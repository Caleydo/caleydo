...
/**
 * Class takes a composite in the constructor and embeds an AWT Frame in it. The Frame can be retrieved over
 * the getEmbeddedFrame() method.
 * 
 * @author Marc Streit
 */
public class SWTEmbeddedGraphWidget
	...
	/**
	 * Constructor that takes the composite in which it should place the content and creates an embedded AWT
	 * frame.
	 * 
	 * @param Composite
