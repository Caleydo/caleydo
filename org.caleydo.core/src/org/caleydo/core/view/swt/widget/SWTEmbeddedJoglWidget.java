...
/**
 * Class takes a composite in the constructor, embeds an AWT Frame in it and finally creates a GLCanvas. The
 * GLCanvas can be retrieved by the getGLCanvas() method.
 * 
 * @author Marc Streit
