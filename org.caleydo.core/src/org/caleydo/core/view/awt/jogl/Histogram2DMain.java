...
//		
//		OneForAllManager rootManager = (OneForAllManager) generalManager;
//		rootManager.initAll();
//		
//	}
//
...
//			this.generalManager.getSingelton().getStorageManager().createStorage( 
...
//			this.generalManager.getSingelton().getVirtualArrayManager().createVirtualArray( 
...
//		
//		ISet createdSet = 
//			this.generalManager.getSingelton().getSetManager().createSet( 
