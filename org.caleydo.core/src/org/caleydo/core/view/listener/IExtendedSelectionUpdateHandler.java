 ...
 * Implementation of this interface are called by {@link ExtendedSelectionUpdateListener}s.
 * 
 * @author Marc Streit
 */
public interface IExtendedSelectionUpdateHandler
	 ...
	 */
	public void handleSelectionUpdate(SelectionDelta selectionDelta, boolean scrollToSelection, String info, String dataDomainID);
