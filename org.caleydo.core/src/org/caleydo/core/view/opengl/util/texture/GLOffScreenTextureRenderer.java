...
public class GLOffScreenTextureRenderer
{
			...
			int iViewHeight)
	{
		...
		// gl.glClearColor(1f, 1.0f, 1.0f, 1f); // Set The Clear Color To Medium
		// Blue
		// Clear The Screen And Depth Buffer
		gl.glClear(GL.GL_COLOR_BUFFER_BIT | GL.GL_DEPTH_BUFFER_BIT);

		gl.glViewport(0, 0, iViewWidth, iViewHeight); // insert real height and
														// width
	}
	...
	// gl.glBindTexture(GL.GL_TEXTURE_2D, iArOffScreenTextures[0]); // Bind To
	// The Blur Texture
