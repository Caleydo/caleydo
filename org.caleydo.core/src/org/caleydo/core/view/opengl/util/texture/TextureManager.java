...
/**
 * Manager handles OpenGL2 icons as textures. The manager must be created for
 * each GL2 view because it needs a current GL2 context!
 * 
...
public class TextureManager {
	...
	public void renderTexture(GL2 gl, final EIconTextures eIconTextures,
			...
			Vec3f upperLeftCorner, float colorR, float colorG, float colorB, float alpha) {

		renderTexture(gl, eIconTextures.getFileName(), lowerLeftCorner, lowerRightCorner,
				upperRightCorner, upperLeftCorner, colorR, colorG, colorB, alpha);
	}
	...
	public void renderGUITexture(GL2 gl, final EIconTextures eIconTextures,
			Vec3f lowerLeftCorner, Vec3f lowerRightCorner, Vec3f upperRightCorner,
			Vec3f upperLeftCorner, Vec3f scalingPivot, float colorR, float colorG,
