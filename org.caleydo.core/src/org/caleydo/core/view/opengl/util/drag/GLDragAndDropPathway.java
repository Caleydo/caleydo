...
/**
 * Object stores the pathway that is currently dragged until it is dropped.
 * 
 * @author Marc Streit
 */
public class GLDragAndDropPathway
{
	...
	public GLDragAndDropPathway(final GLPathwayTextureManager pathwayTextureManager)
	{
	...
	public void renderDragThumbnailTexture(final GL gl, final AGLEventListener containingView)
	{
		...
		pathwayTextureManager.renderPathway(gl, containingView, iDragObjectId, 0.5f, false);
		gl.glPopMatrix();
	}
