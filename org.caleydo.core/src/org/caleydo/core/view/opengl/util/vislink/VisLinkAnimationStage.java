...
/**
 * The class VisLinkAnimationStage provides a structure to store connection lines which should be drawn in the same animation stage. 
 * When animated line drawing is activated, there are several stages. Lines of one stage are drawn at the same time, while lines
 * of the next stage will be drawn when all lines of this stage are finished. This allows more flexibility at creating animations. 
 * It could be intended to draw the lines of specific animation-stages in different direction. To specify the direction of a stages 
 * lines, the variable "drawLinesInReverseDirection" is used. When creating a VisLinkAnimationStage-object, one can set this option.
 * 
 * @author Oliver Pimas
 */
...
public class VisLinkAnimationStage {
	 ...
	 * 
	 * @param connectionLines A list containing all connection lines for this stage.
	 */
	 ...
	 * 
	 * @param connectionLines A list containing all connection lines for this stage.
	 * @param reverseDirection Specifies the drawing.direction of the lines (for animated drawing). 
	 */
	...
	/**
	 * Constructor of class VisLinkAnimationStage. An empty List of lines is created and reverseDirection is set to the given argument.
	 * 
	 * @param connectionLines A list containing all connection lines for this stage.
	 * @param reverseDirection Specifies the drawing.direction of the lines (for animated drawing). 
	 */
	 ...
	 * 
	 * @param reverseDirection True if the lines should be drawn in reverse direction, false otherwise.
	 */
