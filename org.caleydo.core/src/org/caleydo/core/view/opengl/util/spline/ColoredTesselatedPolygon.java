...
/**
 * a per vertex colored {@link TesselatedPolygon}
 * 
 * @author Samuel Gratzl
 * 
 */
final class ColoredTesselatedPolygon implements ITesselatedPolygon {
	private final int windingRule;

	private final Collection<ColoredVec3f> points;

	ColoredTesselatedPolygon(int windingRule, Collection<ColoredVec3f> points) {
