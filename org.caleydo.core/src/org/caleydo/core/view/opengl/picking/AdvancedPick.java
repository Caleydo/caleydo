 ...
 * 
 */
public class AdvancedPick extends Pick {
	public AdvancedPick(int objectID, PickingMode ePickingMode, Point pickedPoint, Point dragStartPoint, float depth, int dx,
