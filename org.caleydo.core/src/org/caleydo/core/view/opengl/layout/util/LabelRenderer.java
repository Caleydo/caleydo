 ...
 * trunkated if necessary.
 * 
 * @author Partl
 * 
 */
public class LabelRenderer extends LayoutRenderer {
	 ...
	 *            ID for picking.
	 */
	public LabelRenderer(AGLView view, String text, EPickingType pickingType,
			int id) {
		this.view = view;
		this.text = text;
	...
	public void render(GL2 gl) {
		...
		textRenderer.renderTextInBounds(gl, text, 0, ySpacing, 0, x, y - 2
				* ySpacing);
