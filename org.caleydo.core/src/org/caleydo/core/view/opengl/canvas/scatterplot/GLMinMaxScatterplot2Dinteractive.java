...
//				getEventPublisher()).updateReceiver(this, selectionSet);
//	 		generalManager.getSingelton().logMsg("broadcast selection event! " + selectionSet.toString(),
//	 				LoggerType.STATUS);
//		}
//	}
//
...
//
//		this.alTargetSet = generalManager.getSingelton().getSetManager()
...
//					((IGraphItem) generalManager.getSingelton().getPathwayItemManager()
