...
public class HeatMapRenderStyle
	...
	public void updateFieldSizesWithFish() {
		int iNumberSelected =
			heatMap.getContentSelectionManager().getNumberOfElements(ESelectionType.MOUSE_OVER);
		iNumberSelected += heatMap.getContentSelectionManager().getNumberOfElements(ESelectionType.SELECTION);
