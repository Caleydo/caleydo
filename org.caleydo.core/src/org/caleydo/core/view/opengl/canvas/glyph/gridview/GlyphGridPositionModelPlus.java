...
//
//		//int axisDefX = Integer.parseInt(gman.getSetting(EGlyphSettingIDs.SCATTERPLOTX));
//		int axisDefX = 6; //male/female
//		
//		int axisDefY = Integer.parseInt(gman.getSetting(EGlyphSettingIDs.SCATTERPLOTY));
