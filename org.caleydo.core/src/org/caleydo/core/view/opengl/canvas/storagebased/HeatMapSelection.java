...
/**
 * HeatMapSelection stores selected elements for usage in the hierarchical heat map
 * 
...
public class HeatMapSelection {
	...
	public HeatMapSelection(int iTexture, int iPos, int iContentIndex, ESelectionType selectionType) {
