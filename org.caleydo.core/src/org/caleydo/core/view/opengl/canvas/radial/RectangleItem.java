...
public class RectangleItem
	 ...
	 * 
	 * @param fArColor
	 *            RGB-Color which shall be used to draw the rectangle. Only the first three values of the
	 *            array will be used.
	 * @param fWidth
	 ...
	 * @param bRelativeSize
	 *            Determines whether changes to the width affects the height (and vice versa) accordingly to
	 *            their relative size or not.
	 */
	public RectangleItem(float[] fArColor, float fWidth, float fHeight, boolean bRelativeSize) {
	...
	/**
	 * Sets whether future changes to the width affects the height (and vice versa) accordingly to their
	 * relative size or not.
	 * 
	 * @param bRelativeSize
