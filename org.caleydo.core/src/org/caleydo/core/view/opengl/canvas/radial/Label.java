...
/**
 * This class holds all information that shall be displayed in a label and additionally keeps important
 * informations the @link {@link LabelManager} requires for positioning and drawing the label properly.
 * 
...
public class Label {
	 ...
	 *            Specifies at which level of the disc segment subtree where labels shall be displayed the
	...
	/**
	 * Sets the center radius of the disc segment (partial disc) to a specified value.
	 * 
	 * @param fSegmentCenterRadius
	...
	/**
	 * Adds a specified {@link LabelLine} at the end of the current list of label lines.
	 * 
	 * @param labelLine
	...
	/**
	 * Sets the X coordinate of the center of the disc segment (partial disc) for the label to the specified
	 * value.
	 * 
	 * @param fSegmentXCenter
	...
	/**
	 * Sets the Y coordinate of the center of the disc segment (partial disc) for the label to the specified
	 * value.
	 * 
	 * @param fSegmentXCenter
	...
	/**
	 * @return The level in the disc segment subtree where labels shall be displayed the current disc segment
	 *         (partial disc) has. I.e. it is the drawing strategy depth of a partial disc where a
	...
	/**
	 * Sets the level of the current disc segment it has in the disc segment subtree where labels shall be
	 * displayed (i.e. the drawing strategy depth of a partial disc where a
	 * {@link PDDrawingStrategyLabelDecorator} has been used) to a specified value.
	 * 
	 * @param iSegmentLabelDepth
