 ...
 */
public class GLDendrogramHorizontal
	...
	private void handleDragging(final GL gl) {
		...
		if ((fArTargetWorldCoordinates[0] - 0.1f) > 0.0f && (fArTargetWorldCoordinates[0] - 0.1f) < fWidth)
	...
	protected void handleEvents(EPickingType ePickingType, EPickingMode pickingMode, int iExternalID,
		...
		switch (ePickingType) {
			...
			case DENDROGRAM_CUT_HORI_SELECTION:
			...
			case DENDROGRAM_HORI_SELECTION:
