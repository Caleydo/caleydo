...
public class GeneClusterElementRepCreator
	implements IElementRepCreator {

	@Override
	public void createElementRep(PartialDisc partialDisc, int iViewID, float fHierarchyCenterX,
