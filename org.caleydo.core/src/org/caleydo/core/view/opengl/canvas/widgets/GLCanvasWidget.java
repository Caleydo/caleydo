...
// import
// org.caleydo.core.data.collection.virtualarray.iterator.IVirtualArrayIterator;
...
// // Position The Text On The Screen...fullscreen goes much slower than the
// other
...
//		
// //
// // float fIncX = (viewingFrame[X][MAX] - viewingFrame[X][MIN]) / (iResolution
// + 1);
// // float fIncY = (viewingFrame[Y][MAX] - viewingFrame[Y][MIN]) / (iResolution
// + 1);
// //
...
// viewingFrame[Z][MIN]); // Top
// // gl.glVertex3f(viewingFrame[X][MAX], viewingFrame[Y][MIN],
// viewingFrame[Z][MIN]); // Bottom left
// // gl.glVertex3f(viewingFrame[X][MAX], viewingFrame[Y][MAX],
// viewingFrame[Z][MIN]); // Bottom left
// // gl.glVertex3f(viewingFrame[X][MIN], viewingFrame[Y][MAX],
// viewingFrame[Z][MIN]); // Bottom left
...
// // gl.glVertex3f(fXvertical, viewingFrame[Y][MIN], viewingFrame[Z][MIN]); //
// Top
// // gl.glVertex3f(fXvertical, viewingFrame[Y][MAX], viewingFrame[Z][MIN]); //
// Bottom left
// //
// // gl.glVertex3f(viewingFrame[X][MIN], fYhoricontal, viewingFrame[Z][MIN]);
// // Top
// // gl.glVertex3f(viewingFrame[X][MAX], fYhoricontal, viewingFrame[Z][MIN]);
// // Bottom left
// //
// // gl.glEnd(); // Finish drawing the triangle
// //
...
//					
// gl.glVertex3f(fX + fAspectRatio[X][OFFSET] , fY +fAspectRatio[Y][OFFSET],
// viewingFrame[Z][MIN]); // Point
// // gl.glVertex3f(fX + fAspectRatio[X][OFFSET] , fY-fTri
// +fAspectRatio[Y][OFFSET], 0.0f); // Point
// // gl.glVertex3f(fX-fTri + fAspectRatio[X][OFFSET] , fY
// +fAspectRatio[Y][OFFSET], 0.0f); // Point
//					
