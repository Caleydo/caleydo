...
public interface ITriggerSelectionCommandHandler {
	...
	/**
	 * Handler method to be called when a TriggerSelectionCommand event is catched
	 * that should trigger a content-selection-command by a related.  
	 * by a related {@link TriggerSelectionCommandListener}.
	...
	/**
	 * Handler method to be called when a TriggerSelectionCommand event is catched
	 * that should trigger a storage-selection-command by a related.  
	 * by a related {@link TriggerSelectionCommandListener}.
	 * @param selectionCommands 
	 */
