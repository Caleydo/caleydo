...
extends GLToolboxRenderer 
{
	 ...
	 */
	public GLGlyphToolboxRenderer(final GL gl,
	...
	public void render(GL gl)
	{
		...
		addIcon(gl, iContainingViewID, EPickingType.PC_ICON_SELECTION, 
				EIconIDs.DISPLAY_CIRCLE.ordinal(), 
				EIconTextures.GLYPH_SORT_CIRCLE);

		addIcon(gl, iContainingViewID, EPickingType.PC_ICON_SELECTION, 
				EIconIDs.DISPLAY_RECTANGLE.ordinal(), 
				EIconTextures.GLYPH_SORT_RECTANGLE);
