...
public class LabelLine {
	...
	/**
	 * Calculates the size of the label line. It also sets the height of each Label item to the height of the
	 * line. The height of the line is determined by the item with the largest height.
	 * 
	 * @param textRenderer
	 *            TextRenderer object which shall be used by text items to render and determine their size.
	 * @param fTextScaling
	 *            Font scaling which shall be used by text items to render and determine their size.
	 ...
	 */
	public void calculateSize(TextRenderer textRenderer, float fTextScaling, int iConsideredLabelTypes) {
		...
		for (ALabelItem currentItem : alLabelItems) {
			if (currentItem instanceof TextItem) {
				((TextItem) currentItem).setRenderingProperties(textRenderer, fTextScaling);
			}
	...
	/**
	 * @return Height of the line. The method calculateSize must have been called before in order to obtain a
	 *         proper value.
	 */
	...
	/**
	 * @return Width of the line. The method calculateSize must have been called before in order to obtain a
	 *         proper value.
	 */
