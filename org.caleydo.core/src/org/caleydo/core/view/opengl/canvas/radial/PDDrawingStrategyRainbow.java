...
/**
 * PDDrawingStrategyRainbow draws partial discs using rainbow colors. The actual color of a partial disc is
 * determined by using the rainbow color mapping on the start angle of the partial disc's center.
 * 
...
public class PDDrawingStrategyRainbow
	...
	/**
	 * Constructor. Initialized the rainbow color mapping. The colors generated by this color mapping are
	 * always combinations of maximum two base colors where the sum of the intensities of the base colors is
	 * equal to 1.
	 * 
