...
/**
 * ADataEventManager is the abstract base class for all DataEventManagers, which are responsible to handle and
 * trigger events which are specific for the data type of hierarchical data that is displayed in the radial
 * hierarchy view.
 * 
 * @author Christian Partl
 */
public abstract class ADataEventManager
	...
	/**
	 * This method is called when a partial disc of the radial hierarchy view is selected. It is responsible
	 * for triggering all events specific for the data object the selected partial disc represents.
	 * 
	 * @param selectionType
	 *            Type of selection.
	 * @param pdSelected
	 ...
	 */
	public abstract void triggerDataSelectionEvents(ESelectionType selectionType, PartialDisc pdSelected);
