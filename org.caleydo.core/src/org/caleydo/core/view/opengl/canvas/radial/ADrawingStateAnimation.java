 ...
 * time between each frame and makes the time difference available to subclasses for being able to execute
 * animations. It also provides several methods for using movement values ({@link MovementValue}) for making
 * animations easier to implement. Animations do not handle any user events.
 * 
...
public abstract class ADrawingStateAnimation
	...
	/**
	 * List of movement values which should be used to alter positions, angles etc. over time.
	 */
	 ...
	 */
	public ADrawingStateAnimation(DrawingController drawingController, GLRadialHierarchy radialHierarchy,
	...
	/**
	 * @return True, if all movement values of the list have reached their target values, false otherwise.
	 */
	 ...
	 *            The time it should take the movement value to reach the target value.
	 ...
	 * 
	 * @param dTimePassed
	 *            The time that has passed between the last and the current frame.
	 */
