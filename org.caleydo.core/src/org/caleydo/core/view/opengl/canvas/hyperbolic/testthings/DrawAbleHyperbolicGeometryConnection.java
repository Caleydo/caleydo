...
// }
//	
// public DrawAbleHyperbolicGeometryConnection(IDrawAbleNode iNodeA, IDrawAbleNode iNodeB, ITreeProjection
// treeProjector) {
// super(iNodeA, iNodeB, treeProjector);
// // TODO Auto-generated constructor stub
// }
//
//
...
//		
//		
// // float length = (float)Math.sqrt(Math.pow(pEndP.x() - pStartP.x(), 2) + Math.pow(pEndP.y() - pStartP.y(),
// 2));
...
// //
// //
// // float fZCoordOfProjectedPoint = fvHTCenterpoint.z() +
// (float)Math.cos(fYAngle)*(float)Math.cos(fXAngle)*fHTRadius;
// //
...
//
// @Override
// protected void calculateSplinePoints() {
