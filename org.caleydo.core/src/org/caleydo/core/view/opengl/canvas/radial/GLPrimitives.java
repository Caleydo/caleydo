...
public class GLPrimitives {
	 ...
	 *            The number of slices which would be drawn to approximate a full disc. Higher numbers produce
	 *            a better approximation but the performance is worse.
	 */
	public static void renderPartialDisc(GLU glu, float fInnerRadius, float fOuterRadius, float fStartAngle,
		float fAngle, int iNumSlicesPerFullDisc) {
