 ...
 *
 */
public class CmdGlObjectRemoteGlyph 
extends ACmdCreate_GlCanvasUser {
			...
			final CommandQueueSaxType commandQueueSaxType)
	{
		...
		localManagerObjectType = CommandQueueSaxType.CREATE_GL_REMOTE_GLYPH;
	}
	...
	public final void doCommand() {
		...
		((GLCanvasRemoteGlyph)gLEventListener).addSetId(iArTmp);	
	}
