 ...
 * the IMemento only. The creator-object stores its state in a derived calls of
 * IMementoState, which contains all information needed to restore the current
 * state.
 * 
...
public interface IMemento
{
	 ...
	 * Throws CaleydoRuntimeException if an inappropriate
	...
	/**
	 * Each class is be able to restore it's previous status using the
	 * information stored in the IMementoState object.
	 * 
	...
	/**
	 * Overwrite toString() to get valuable debug information. Note: This method
	 * is used by IMementoManager.toString()
	 */
