...
public interface IMementoCallbackXML
{
	...
	/**
	 * Defines a callback, that can be triggered by the parser once a certain
	 * tag is reached. Note: this is used to notify the end of a tag in most
	 * cases, to be able to create an object with the information provided. This
