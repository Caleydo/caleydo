...
public interface IContainer<DataType> {
	...
	/**
	 * Brings any dataset into a format between 0 and 1. This is used for drawing. For nominal data the first value is
	 * 0, the last value is 1
	 */
	public FloatContainer normalize();

	public ERawDataType getRawDataType();

	public DataType getValue(int index);

	public void addValue(DataType dataType);
