...
implements IStorage
{
	...
	/*
	 * (non-Javadoc)
	 * @see org.caleydo.core.data.collection.NISet#getFloat(org.caleydo.core.data.collection.nstorage.EStorageKind, int)
	 */
	public float getFloat(EDataKind storageKind, int iIndex)
	{
		...
		PrimitiveFloatCContainer fStorage = (PrimitiveFloatCContainer)hashCContainers.get(storageKind);
		return fStorage.get(iIndex);
	}
	
	/*
	 * (non-Javadoc)
	 * @see org.caleydo.core.data.collection.NISet#floatIterator(org.caleydo.core.data.collection.nstorage.EStorageKind)
	 */
	...
	public float getInt(EDataKind storageKind, int iIndex)
	{
		...
		PrimitiveIntCContainer iStorage = (PrimitiveIntCContainer)hashCContainers.get(storageKind);
		return iStorage.get(iIndex);
	}
	
	/*
	 * (non-Javadoc)
	 * @see org.caleydo.core.data.collection.NISet#intIterator(org.caleydo.core.data.collection.nstorage.EStorageKind)
	 */
