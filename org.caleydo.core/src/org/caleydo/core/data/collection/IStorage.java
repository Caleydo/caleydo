	...
	extends IUniqueObject, ICollection
{
	...
	/**
	 * Set the label of a set. A label is for example the name of the column, or
	 * the identifier for the dataset It is used for printing identifications
	 * 
	 * @param sLabel
	...
	/**
	 * Returns the label. If nothing was specified with setLabel it returns an
	 * empty string.
	 * 
	 * @return
	 */
	 ...
	 * the storage this is used. For nominal data the first value is 0, the last
	 * value is 1
	 */
