...
import org.caleydo.core.data.collection.virtualarray.iterator.VirtualArrayNullIterator;
...
public class VirtualArrayVectorIterator implements IVirtualArrayIterator {
	...
	/* (non-Javadoc)
	 * @see org.caleydo.core.data.collection.selection.iterator.IVirtualArrayIterator#size()
	 */
	public int size() {
	...
	/* (non-Javadoc)
	 * @see org.caleydo.core.data.collection.selection.iterator.IVirtualArrayIterator#remaining()
	 */
	...
	/* (non-Javadoc)
	 * @see org.caleydo.core.data.collection.selection.iterator.IVirtualArrayIterator#getVirtualIndex()
	 */
	...
	/* (non-Javadoc)
	 * @see org.caleydo.core.data.collection.selection.iterator.IVirtualArrayIterator#setVirtualIndex(int)
	 */
