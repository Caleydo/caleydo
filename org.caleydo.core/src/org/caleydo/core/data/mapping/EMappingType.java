...
public enum EMappingType {
	...
	BIOCARTA_GENE_ID_2_REFSEQ_MRNA(
		...
		EIDType.REFSEQ_MRNA,
		EMappingDataType.MULTI_STRING2STRING),
	...
	GENE_NAME_2_DAVID(EIDType.GENE_NAME, EIDType.DAVID, EMappingDataType.STRING2INT),
	...
	OLIGO_2_EXPRESSION_INDEX(EIDType.OLIGO, EIDType.EXPRESSION_INDEX, EMappingDataType.MULTI_STRING2INT),
	REFSEQ_MRNA_INT_2_OLIGO(EIDType.REFSEQ_MRNA_INT, EIDType.OLIGO, EMappingDataType.INT2STRING),
	OLIGO_2_REFSEQ_MRNA_INT(EIDType.OLIGO, EIDType.REFSEQ_MRNA_INT, EMappingDataType.STRING2INT),
	REFSEQ_MRNA_2_OLIGO(EIDType.REFSEQ_MRNA, EIDType.OLIGO, EMappingDataType.STRING2STRING),

	UNSPECIFIED_2_EXPRESSION_INDEX(EIDType.UNSPECIFIED, EIDType.EXPRESSION_INDEX, EMappingDataType.STRING2INT),
	EXPRESSION_INDEX_2_UNSPECIFIED(EIDType.EXPRESSION_INDEX, EIDType.UNSPECIFIED, EMappingDataType.INT2STRING);
