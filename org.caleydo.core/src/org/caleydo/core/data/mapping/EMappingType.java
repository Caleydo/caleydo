...
public enum EMappingType {
	...
	DAVID_2_EXPRESSION_INDEX(EIDType.DAVID, EIDType.EXPRESSION_INDEX, false),
	REFSEQ_MRNA_INT_2_EXPRESSION_INDEX(EIDType.REFSEQ_MRNA_INT, EIDType.EXPRESSION_INDEX, true),
	REFSEQ_MRNA_2_EXPRESSION_INDEX(EIDType.REFSEQ_MRNA, EIDType.EXPRESSION_INDEX, true),
	EXPRESSION_INDEX_2_DAVID(EIDType.EXPRESSION_INDEX, EIDType.DAVID, false),
	EXPRESSION_INDEX_2_REFSEQ_MRNA_INT(EIDType.EXPRESSION_INDEX, EIDType.REFSEQ_MRNA_INT, false),
	EXPRESSION_INDEX_2_REFSEQ_MRNA(EIDType.EXPRESSION_INDEX, EIDType.REFSEQ_MRNA, false),
	...
	BIOCARTA_GENE_ID_2_REFSEQ_MRNA(EIDType.BIOCARTA_GENE_ID, EIDType.REFSEQ_MRNA, true),
	EXPRESSION_INDEX_2_GENE_SYMBOL(EIDType.EXPRESSION_INDEX, EIDType.GENE_SYMBOL, false),
	GENE_SYMBOL_2_EXPRESSION_INDEX(EIDType.GENE_SYMBOL, EIDType.EXPRESSION_INDEX, false),

	EXPRESSION_INDEX_2_GENE_NAME(EIDType.EXPRESSION_INDEX, EIDType.GENE_NAME, false),
	GENE_NAME_2_EXPRESSION_INDEX(EIDType.GENE_NAME, EIDType.EXPRESSION_INDEX, false),
	
	EXPRESSION_INDEX_2_ENSEMBL_GENE_ID(EIDType.EXPRESSION_INDEX, EIDType.ENSEMBL_GENE_ID, false),
	ENSEMBL_GENE_ID_2_EXPRESSION_INDEX(EIDType.ENSEMBL_GENE_ID, EIDType.EXPRESSION_INDEX, false),

	EXPRESSION_INDEX_2_BIOCARTA_GENE_ID(EIDType.EXPRESSION_INDEX, EIDType.BIOCARTA_GENE_ID, false),
	BIOCARTA_GENE_ID_2_EXPRESSION_INDEX(EIDType.BIOCARTA_GENE_ID, EIDType.EXPRESSION_INDEX, false),

	EXPRESSION_INDEX_2_ENTREZ_GENE_ID(EIDType.EXPRESSION_INDEX, EIDType.ENTREZ_GENE_ID, false),
	ENTREZ_GENE_ID_2_EXPRESSION_INDEX(EIDType.ENTREZ_GENE_ID, EIDType.EXPRESSION_INDEX, false),
	...
	DAVID_2_ENSEMBL_GENE_ID(EIDType.DAVID, EIDType.ENSEMBL_GENE_ID, false),
	ENSEMBL_GENE_ID_2_DAVID(EIDType.ENSEMBL_GENE_ID, EIDType.DAVID, false),
	...
	EXPRESSION_INDEX_2_OLIGO(EIDType.EXPRESSION_INDEX, EIDType.OLIGO, false),
