...
public enum EMappingType
{
	...
	BIOCARTA_GENE_ID_2_DAVID(EIDType.BIOCARTA_GENE_ID, EIDType.DAVID, EMappingDataType.STRING2INT),
	BIOCARTA_GENE_ID_2_REFSEQ_MRNA(EIDType.BIOCARTA_GENE_ID, EIDType.REFSEQ_MRNA, EMappingDataType.STRING2STRING),
	DAVID_2_GENE_SYMBOL(EIDType.DAVID, EIDType.GENE_SYMBOL, EMappingDataType.INT2STRING),
	GENE_SYMBOL_2_DAVID(EIDType.GENE_SYMBOL, EIDType.DAVID, EMappingDataType.INT2STRING),
