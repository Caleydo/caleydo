...
public interface IGroupList<ConcreteType extends IGroupList<ConcreteType, VA, VADelta>, VA extends VirtualArray<?, ?, ?, ?>, VADelta extends VirtualArrayDelta<?, ?>>
	 ...
	 */
	public boolean merge(VA virtualArray, int iIndex1, int iIndex2);
	 ...
	 * @return true if operation executed correctly otherwise false
	 */
	public boolean interchange(VA virtualArray, int iIndex1, int iIndex2);
	 ...
	 * @return true if operation executed correctly otherwise false
	 */
	public boolean move(VA virtualArray, int iSrcIndex, int iTargetIndex);
