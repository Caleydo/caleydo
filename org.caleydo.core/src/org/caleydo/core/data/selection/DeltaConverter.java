 ...
 * </p>
 * <p>
 * Based on the internal type of a delta, which is the source type and a
 * supplied target type a new delta is created which contains the original id as
 * its secondary ID and the new converted ID as the primary ID. Any previous
 * secondary ID is not preserved.
 * </p>
 * <p>
 * Due to the n:m relations of mappings the resulting delta can have a length
