...
public class InitiateClusterCreationEventListener extends AEventListener<GLStratomex> {
	
	@Override
	public void handleEvent(AEvent event) {
		if (event instanceof InitiateClusterCreationEvent) {
			...
			handler.getClusterCreator().InitiateClusterCreation(((InitiateClusterCreationEvent) event).getSourceBrick());
