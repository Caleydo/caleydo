 ...
 *
 */
public class ClientByteStreamLoggerHandler extends ClientByteStreamHandler {
	 ...
	 * @param nServerPort
	 */
	public ClientByteStreamLoggerHandler(LogInterface logger,
			String nServerName, int nServerPort) {
