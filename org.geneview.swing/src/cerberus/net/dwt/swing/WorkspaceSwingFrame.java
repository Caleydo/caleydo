...
extends JFrame
implements IUniqueManagedObject, IWorkspaceSwingFrame {
	...
	private IWorkspaceSwingFrame refTargetFrame;
	...
	/* (non-Javadoc)
	 * @see cerberus.net.dwt.swing.IWorkspaceSwingFrame#initCanvas()
	 */
...
//				ManagerObjectType.STORAGE_FLAT.name() );
	...
	/* (non-Javadoc)
	 * @see cerberus.net.dwt.swing.IWorkspaceSwingFrame#flipDesktopPane(cerberus.net.dwt.swing.mdi.DDesktopPane)
	 */
	...
	/* (non-Javadoc)
	 * @see cerberus.net.dwt.swing.IWorkspaceSwingFrame#flipDMenuBootStraper(cerberus.net.dwt.swing.menu.DMenuBootStraper)
	 */
	...
	/* (non-Javadoc)
	 * @see cerberus.net.dwt.swing.IWorkspaceSwingFrame#getJMenuBar()
	 */
	...
	/* (non-Javadoc)
	 * @see cerberus.net.dwt.swing.IWorkspaceSwingFrame#getDMenuBootStraper()
	 */
	...
	/* (non-Javadoc)
	 * @see cerberus.net.dwt.swing.IWorkspaceSwingFrame#setTargetFrame(cerberus.net.dwt.swing.WorkspaceSwingFrame)
	 */
	...
	/* (non-Javadoc)
	 * @see cerberus.net.dwt.swing.IWorkspaceSwingFrame#getDesktopPane()
	 */
	...
	/* (non-Javadoc)
	 * @see cerberus.net.dwt.swing.IWorkspaceSwingFrame#createDInternalFrame(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see cerberus.net.dwt.swing.IWorkspaceSwingFrame#getManager()
	 */
	...
	/* (non-Javadoc)
	 * @see cerberus.net.dwt.swing.IWorkspaceSwingFrame#setId(int)
	 */
	...
	/* (non-Javadoc)
	 * @see cerberus.net.dwt.swing.IWorkspaceSwingFrame#getId()
	 */
	public int getId() {
	...
	/* (non-Javadoc)
	 * @see cerberus.net.dwt.swing.IWorkspaceSwingFrame#getTargetFrameId()
	 */
	...
	/* (non-Javadoc)
	 * @see cerberus.net.dwt.swing.IWorkspaceSwingFrame#getBaseType()
	 */
