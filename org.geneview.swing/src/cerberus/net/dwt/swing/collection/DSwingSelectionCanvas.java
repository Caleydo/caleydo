...
extends JPanel 
implements DNetEventComponentInterface, IViewCanvas, IDSwingSelectionCanvas
{
...
//	}
	 ...
	 * 
	 */
	public DSwingSelectionCanvas( IGeneralManager refGeneralManager ) {
		// super(); // call JPanel ??
	...
	/* (non-Javadoc)
	 * @see cerberus.net.dwt.swing.collection.IDSwingSelectionCanvas#getManager()
	 */
...
//		rowGridLayout.setRows( sHeaderListLabel.length );
	 ...
	 */
	/* (non-Javadoc)
	 * @see cerberus.net.dwt.swing.collection.IDSwingSelectionCanvas#addNetActionListener(cerberus.net.dwt.DNetEventListener)
	 */
	 ...
	 */
	/* (non-Javadoc)
	 * @see cerberus.net.dwt.swing.collection.IDSwingSelectionCanvas#handleNetEvent(cerberus.net.dwt.DNetEvent)
	 */
	 ...
	 */
	/* (non-Javadoc)
	 * @see cerberus.net.dwt.swing.collection.IDSwingSelectionCanvas#addCommandListener(cerberus.command.ICommandListener)
	 */
	 ...
	 */
	/* (non-Javadoc)
	 * @see cerberus.net.dwt.swing.collection.IDSwingSelectionCanvas#containsNetEvent(cerberus.net.dwt.DNetEvent)
	 */
	 ...
	 */
	/* (non-Javadoc)
	 * @see cerberus.net.dwt.swing.collection.IDSwingSelectionCanvas#getNetEventComponent(cerberus.net.dwt.DNetEvent)
	 */
	 ...
	 */
	/* (non-Javadoc)
	 * @see cerberus.net.dwt.swing.collection.IDSwingSelectionCanvas#getId()
	 */
	public int getId() {
	 ...
	 */
	/* (non-Javadoc)
	 * @see cerberus.net.dwt.swing.collection.IDSwingSelectionCanvas#setId(int)
	 */
	...
	/* (non-Javadoc)
	 * @see cerberus.net.dwt.swing.collection.IDSwingSelectionCanvas#setParentCreator(cerberus.manager.IDistComponentManager)
	 */
	...
	/* (non-Javadoc)
	 * @see cerberus.net.dwt.swing.collection.IDSwingSelectionCanvas#setParentComponent(cerberus.net.dwt.DNetEventComponentInterface)
	 */
	 ...
	 */
	/* (non-Javadoc)
	 * @see cerberus.net.dwt.swing.collection.IDSwingSelectionCanvas#setMementoXML_usingHandler(cerberus.xml.parser.ISaxParserHandler)
	 */
...
//			}
	 ...
	 */
	/* (non-Javadoc)
	 * @see cerberus.net.dwt.swing.collection.IDSwingSelectionCanvas#createMementoXMLperObject()
	 */
...
//		}
	 ...
	 */
	/* (non-Javadoc)
	 * @see cerberus.net.dwt.swing.collection.IDSwingSelectionCanvas#createMementoXML()
	 */
	 ...
	 */
	/* (non-Javadoc)
	 * @see cerberus.net.dwt.swing.collection.IDSwingSelectionCanvas#callbackForParser(cerberus.manager.type.ManagerObjectType, java.lang.String, java.lang.String, cerberus.xml.parser.ISaxParserHandler)
	 */
	...
	/* (non-Javadoc)
	 * @see cerberus.net.dwt.swing.collection.IDSwingSelectionCanvas#getBaseType()
	 */
	...
	/* (non-Javadoc)
	 * @see cerberus.net.dwt.swing.collection.IDSwingSelectionCanvas#paintDComponent(java.awt.Graphics)
	 */
...
//				iHistogramCell_offsetY );
	...
	/* (non-Javadoc)
	 * @see cerberus.net.dwt.swing.collection.IDSwingSelectionCanvas#notifySelectionHasChangedInGui()
	 */
	...
	/* (non-Javadoc)
	 * @see cerberus.net.dwt.swing.collection.IDSwingSelectionCanvas#updateAllSelectionsFromGui()
	 */
	 ...
	 */
	/* (non-Javadoc)
	 * @see cerberus.net.dwt.swing.collection.IDSwingSelectionCanvas#updateState()
	 */
